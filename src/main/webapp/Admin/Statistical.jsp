	...
	<main class="container bg-dark">
		<nav class="navbar navbar-light bg-light fixed-bot">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Noob Food</a>
					...
					<div class="offcanvas-body">
						<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
							<li class="nav-item"><a class="nav-link" aria-current="page"
								href="/finaldam/Homeadmin"> <svg xmlns="http://www.w3.org/2000/svg" width="40"
										height="40" fill="currentColor" class="bi bi-house-fill"
										viewBox="0 0 16 16">
							...
							<li class="nav-item"><a class="nav-link " href="/finaldam/Notify"> <svg
							...
							<li class="nav-item  "><a class="nav-link active" href="/finaldam/statistical">
			...
			<div class="bg-dark">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item " role="presentation">
						<button class="nav-link active" id="booking-tab"
							...
							role="tab" aria-controls="booking" aria-selected="true">số
							bàn đã đặt</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="food-tab" data-bs-toggle="tab"
							data-bs-target="#profile" type="button" role="tab"
							aria-controls="food" aria-selected="false">Số hàng đã
							thanh toán</button>
					</li>
				</ul>
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active " id="booking"
						...
						<form action="/finaldam/statistical" method="post"
							enctype="multipart/form-data">
							<button formaction="/finaldam/statistical/appointment"
					...
					<div class="tab-pane fade" id="profile" role="tabpanel"
						...
						<form action="/finaldam/statistical" method="post"
							enctype="multipart/form-data">
							<button formaction="/finaldam/statistical/hoadon"
								class="btn btn-primary text-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									fill="currentColor" class="bi bi-file-earmark-arrow-down"
									viewBox="0 0 16 16">
