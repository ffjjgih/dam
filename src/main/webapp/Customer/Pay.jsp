...
<body>
									...
									<li class="nav-item dropdown"><a
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item"
												href="/finaldam/Changepassword">change password</a></li>
											<li>
												<hr class="dropdown-divider">
											</li>
											<li><a class="dropdown-item" href="/finaldam/Profile"> <svg
											...
											<li><a class="dropdown-item" href="/finaldam/History"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
  ...
  <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
        ...
        <section class="row">
        <form action="/finaldam/Pay" method="post">
          <div class="card text-center">
  					<div class="card-header">
    					Lời Cảm Ơn
  					</div>
  					<div class="card-body">
    					<h5 class="card-title">Cảm ơn quý khách đã mua hàng bên cửa hàng chúng tôi</h5>
    						<p class="card-text">chúc bạn có bữa ăn vui vẻ bên gia đình bạn bè. xin trân thành cảm ơn</p>
    					<button formaction="/finaldam/Home?index=${idcustomer }" class="btn btn-primary">Về Trang chủ</button>
  					</div>
  					<div class="card-footer text-muted">
    					Chúc quý khách một ngay tốt lành
  					</div>
				</div>
				</form>
        </section>
