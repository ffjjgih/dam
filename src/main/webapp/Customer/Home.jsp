...
<body>
  ...
  <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
			...
			<div class="carousel-inner">
				<div class="carousel-item active" data-bs-interval="1">
					<img src="..." class="d-block w-100" alt="..."
						style="width: 1080px; height: 350px">
				</div>
				<c:forEach items="${dsbanner }" var="item">
					<c:if test="${item.poster==null }">
						<div class="carousel-item" data-bs-interval="10000">
							<img src="${item.banner }" class="d-block w-100" alt="..."
								style="width: 1080px; height: 350px">
						</div>
					</c:if>
				</c:forEach>
		...
		<section class="row">
			<div class="container">
				<div class="row">
					<c:forEach items="${lsthome}" var="item">
						<c:if test="${item.poster!=null}">
							<div class="col">
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">${item.summaryContent }</p>
										<a href="${item.link }" class="btn btn-primary">Go
											somewhere</a>
									</div>
								</div>
							</div>
