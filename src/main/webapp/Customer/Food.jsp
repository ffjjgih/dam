...
<body>
  ...
  <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
					...
					<c:forEach items="${lstfood}" var="f">
							<div class="col" style="margin-top:10px">
								<div class="card" style="width: 18rem;">
									<img src="${f.poster }" class=" img-thumbnail"
										alt="..." style="width: 285px; height: 180px;">
									<div class="card-body">
										<b id="foodname">${f.namefood}</b></br></br>
                                    	<input type="text" name="price" id="price" style="color: red; margin-left: 60px;" value="${f.gia}" readonly>
										<div class="card-footer">
										<form action="/finaldam/Food" method="post">
                                <c:choose>
                                	<c:when test="${idcustomer!=null}">
                                		<button formaction="/finaldam/Food/Pay?index=${idcustomer}&&id=${f.foodid }"
                                    ...
                                    <button onclick="thongbao()" formaction="/finaldam/Food/Cart?index=${idcustomer}&&id=${f.foodid }"
                                	...
                                	<c:otherwise>
                                		<a href="/finaldam/Login.jsp" onclick="thongbao1()"
                                        class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart-check-fill" viewBox="0 0 16 16">
                                            <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708z"/>
                                        </svg>BUY</a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js"
        ...
        function thongbao1(){
        	alert('you are not logged in, please login then come back.');
        }
        </script>
</body>
</html>